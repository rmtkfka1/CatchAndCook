...
void RootSignature::Init()
{
	...
	auto G_SHADOW_SRV_RANGE   = CD3DX12_DESCRIPTOR_RANGE(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 1,10);
	auto G_POSITION_SRV_RANGE = CD3DX12_DESCRIPTOR_RANGE(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 1, 11);
	auto G_NORAML_SRV_RANGE  = CD3DX12_DESCRIPTOR_RANGE(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 1, 12);
	auto G_COLOR_SRV_RANGE   = CD3DX12_DESCRIPTOR_RANGE(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 1, 13);
	auto G_DEPTH_SRV_RANGE   = CD3DX12_DESCRIPTOR_RANGE(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 1, 14);
	...
	auto SPRITE_RANGE = CD3DX12_DESCRIPTOR_RANGE(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 1, 8);

	array<CD3DX12_ROOT_PARAMETER, 16> param;
