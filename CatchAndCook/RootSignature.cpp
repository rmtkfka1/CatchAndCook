...
void RootSignature::Init()
{
	...
	{
		auto SRV_STRUCTURED_RANGE   = CD3DX12_DESCRIPTOR_RANGE(D3D12_DESCRIPTOR_RANGE_TYPE_SRV,1,SRV_STRUCTURED_TABLE_REGISTER_OFFSET + i);
		param[SRV_STRUCTURED_TABLE_INDEX + i].InitAsDescriptorTable(1,&SRV_STRUCTURED_RANGE);
	}
