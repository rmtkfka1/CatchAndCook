...
size_t GLOBAL_SRV_MAO_INDEX       = CBV_ROOT_INDEX_COUNT + 7;
size_t GLOBAL_SRV_DEPTH_INDEX     = CBV_ROOT_INDEX_COUNT + 8;
size_t SRV_STRUCTURED_TABLE_INDEX = CBV_ROOT_INDEX_COUNT + 9; //21~30
size_t SRV_LIGHTPARM_TABLE_INDEX  = CBV_ROOT_INDEX_COUNT + 19; //31
