...
size_t GLOBAL_SHADOW_SRV    = CBV_ROOT_INDEX_COUNT + 2;
size_t GLOBAL_POSITION_SRV  = CBV_ROOT_INDEX_COUNT + 3;
size_t GLOBAL_NORAML_SRV    = CBV_ROOT_INDEX_COUNT + 4;
size_t GLOBAL_COLOR_SRV     = CBV_ROOT_INDEX_COUNT + 5;
size_t GLOBAL_DEPTH_SRV     = CBV_ROOT_INDEX_COUNT + 6;
